...
demand = results.node['demand']  #Pandas DataFrame with demand at each node over time
quality = results.node['quality']  #Pandas DataFrame with quality at each node over time
...
MUTATION_RATE = 0.1  #The probability of mutating an individual
...
node_quality = results.node['quality'].iloc[-1,:]  # Get quality results at specified time
